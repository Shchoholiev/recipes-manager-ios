...
class RecipesService: ServiceBase {
    ...
    func getPageAsync(pageNumber: Int = 1, pageSize: Int = 15, searchType: RecipesSearchTypes = .PUBLIC, search: String = "", categoriesIds: [String] = [], authorId: String = "") async -> PagedList<Recipe>? {
